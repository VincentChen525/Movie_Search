...
public class MyIndexReader {
	...
	public MyIndexReader( String indexPathStr ) throws IOException {
	 ...
	 * @throws IOException
	 */
	public String DoContent(int docid) throws IOException{
		Document doc = isearcher.doc(docid);
		return (doc==null)?null:doc.get("test_content");
	}
